...
cssInterop(AlertDialogPrimitive.Content, { className: 'style' });
cssInterop(AlertDialogPrimitive.Title, { className: 'style' });
cssInterop(AlertDialogPrimitive.Description, { className: 'style' });
cssInterop(AlertDialogPrimitive.Action, { className: 'style' });
        ...
        <AlertDialogPortal hostName={portalHost}>
            <AlertDialogOverlay>
                <AlertDialogPrimitive.Content
                    ref={ref}
                    className={cn(
                        ' max-w-lg gap-4 border border-border bg-background p-6 shadow-lg shadow-foreground/10 web:duration-200 rounded-lg',
                        open
